...
- **תקרת הקיבוץ שומרת את הקבוצות הטובות ביותר, גלובלית** – בהגעה
  ...
  סגמנט* שהצטברו לפני המיזוג למאות MB באינדקס לא-ממוזג; שיא הזיכרון
  כעת ~7MB לחיפוש, ללא תלות במספר הסגמנטים. שארית ה-degrade תחת
...
- **תקציב לספירת הסעיפים בהתאמה חלקית בטווח "תחת אותה כותרת"** – מפת
  ...
  קשיח (500k סעיפים, ~24MB): מעבר אליו סעיפים *חדשים* נשמטים עם
